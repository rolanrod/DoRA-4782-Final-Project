# coding=utf-8
### This implementation is built off of `lora.py`, also in this directory, which
### we give full credit to Microsoft Research
...
## TODO0: put the util funcitons in this file
...
class DoraConfig(PeftConfig):
    ...
    ## TODO1: dora_simple and Wdecompose_target_modules
...
class LoraModel(torch.nn.Module):
    ...
    def _find_and_replace(self):
        ...
        for key in key_list:
            ...
            # TODO3: if isinstance(self.peft_config.Wdecompose_target_mdolues, str)
            # elif
            # else
        ...
        # TODO6: elif wdecompose_target_module_found
...
class LoraLayer:
    def __init__(
        ...
        self.disable_adapters = False # TODO8: added in


# TODO9: Update `Linear` layer to include DoRA functionality
## Key change is `wdecomp`
...
class Linear(nn.Linear, LoraLayer):
    ...
    ## TODO TODO - very different forward pass!
...
# TODO12: deal with the below
## Below is NotImplementedError
# if is_bnb_available():
